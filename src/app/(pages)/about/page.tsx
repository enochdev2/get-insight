    ...
    <section className="w-full min-h-screen py-12 ">
      <div className="w-5/6 m-auto text-xl py-8 px-5 rounded-lg bg-slate-200 dark:bg-transparent">
        ...
        <p className="text-justify my-4 text-[18px]">
         Dev-Noch Technology is a Web Development company, having the goal of providing our clients with an exceptional web  user experiences. Delivering Top-quality software solutions that tackle complex business challenges.
        </p>
        <p className="text-justify my-4 text-[18px]">
