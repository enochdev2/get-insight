        ...
        <div className="flex-1 ">
          <form onSubmit={handleSubmit} className="w-[80%] m-auto py-4">
            ...
            <button
              ...
              className="flex gap-4 justify-center w-[85%] m-auto  py-2 px-2 border border-sky-900 text-base md:text-lg font-semibold rounded-full bg-slate-100  dark:bg-slate-800"
            >
              <Image
                src={"/google.png"}
                alt={"googleLogin"}
          ...
          <h3 className="mb-4 text-center text-lg">
            ...
            <Link href="/login" className="text-sky-900">
              Login Here
            </Link>
          </h3>
        </div>
