...
const TechArvel = () => {
  return (
    <div
      className={`mt-12 mx-auto backdrop-blur-lg bg-black/30 rounded-[20px]`}
    >
      <div
      ...
      >
        <motion.div variants={textVariant()}>
          ...
          <h2 className="text-white font-bold my-4 md:text-[45px] sm:text-[30px] text-[25px]">
            Elevate Your Business with Expert Development Solutions
          </h2>
          <p className="text-[#abacf1] text-base md:text-xl">
            Are you ready to elevate your project with cutting-edge development
            solutions? Look no further! At{" "}
            <span className="text-lg md:text-2xl font-bold text-[#0004ff] ">
              TechArvel
            </span>{" "}
            , we specialize in delivering top-notch development services across
            the full stack. Whether you&apos;re building a new web application,
            creating a blockchain solution, or anything in between, we&apos;ve
            got you covered!
          </p>
        </motion.div>
      </div>
      <div
        className={`-mt-20 pb-14 sm:px-2 px-2 md:px-5 lg:px-8 flex flex-wrap  gap-3`}
      >
        {testimonials.map((testimonial: any, index: any) => (
          ...
          >
            ...
            <div className="mt-1">
              <p className="text-[#bac6ec] px-1 pt-4 text-[16px] md:text-[20px]">
        ...
        <div className="flex flex-wrap gap-5 mt-3 text-white w-full justify-between">
          <p className="bg-gradient-to-r from-[#080935] via-[#321894] to-[#686ec2] rounded-lg  px-3 py-2   ">
            👉 Contact Us:{" "}
            <a href="" className="text-[#f7c0c0]">
              {" "}
              smartdevelopments.info@gmail.com
            </a>
          </p>
